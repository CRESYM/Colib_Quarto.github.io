...
categories: [Opensource, single-phase, three-phase, EMT, RMS, DynamicPhasor,  CIM, WECC, CIGRE, IEEE, IEC, Modelica, Julia, Python, RTDS, DigSilent Power Factory, PSSE, STEPSS, dynawo, NEPLAN, DPSin, EMTP, PSCAD, NEPLAN, Matlab, OpalRT, powerworld, GE PSLF, PSS, Governor, HVDC, line] # categories: opensource, phase number, modeling detail level, standard, language, device name
...
csl: ../../_bibliography/diabetologia.csl
...
![Synchronous machine](SM1_model_scheme.svg){#fig-SM1 fig-alt="Synchronous machine" width="400px"}
