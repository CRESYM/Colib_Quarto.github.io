...
categories: [DC, Grid Following, Grid Forming, OpenSource, Matlab, VSC, small] 
date: 24/10/2024  
...
- [Grid Forming VSC model](../../models/4-HVDC/VSC/GridFormingConverter/UPC-EMT-GFM-VSC/index.qmd)
- [Grid Following VSC model](../../models/4-HVDC/VSC/GridFollowingConverter/UPC-EMT-GFL-VSC/index.qmd)
- [HVDC model page](../../models/4-HVDC/VSC/Point-to-Point-HVDC/UPC-EMT-HVDC/index.qmd)
...
![HVDC scheme](HVDC_scheme.svg){#fig-hvdc-scheme}


## Static and Dynamic models​ description 

- The grid is represented by ideal Voltage Sources.
- The load is a constant impedance [ZIP load](../../models/2-Loads/ZIPLoad/index.qmd).
- The Grid Following converter controls includes a DC Voltage regulation, similar to the controls described in the [STATCOM model](../../models/3-CompensationAndFACTS/STATCOM/index.qmd).
- The Grid Forming converter controls include a frequency and voltage regulation using the droop control approach described in the [Grid Forming VSC model](../../models/4-HVDC/VSC/GridFormingConverter/UPC-EMT-GFM-VSC/index.qmd).
...
| ----------- | -------------------- | --------- | ---------- |
| Converter - grid filter (grid connection) | $2.45$ | $0.0326$ | $0.001038$ |
| Converter - capacitor (GFM) | $2.45$ | $0.0048913$ | $0.00031139$ |
...
![VDC_GFOL](VDC_GFOL.svg){#fig-vdc-gfol}

![VDC_GFM](VDC_GFM.svg){#fig-vdc-gfm}
...
![Qg_GFOL](Qg_GFOL.svg){#fig-qg-gfol}
...
![P_GFOL](P_GFOL.svg){#fig-p-gfol}

![P_GFM](P_GFM.svg){#fig-p-gfm}
