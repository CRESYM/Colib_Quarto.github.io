...
categories: [opensource, System frequency response model, centre of inertia, underfrequency load shedding, low frequency demand disconnection, Python, Matlab, Simulink, '#154'] 
date: 03/06/2024  
...
All 4 cases are based on the Underfrequency load shedding protection scheme and SSystem frequency response model as described [here](../../../models/7-Protection/LoadShedding/UFLS/index.qmd)
...
![Case study #1: electric power system frequency response, obtained with SFRM without UFLS](Fig1_CS1.jpg){#fig-cs1}

![Case study #2: electric power system frequency response, obtained with SFRM with conventional UFLS](Fig2_CS2.jpg){#fig-cs2}

![Case study #3: electric power system frequency response, obtained with SFRM and UL (L-shaped threshold function)](Fig3_CS3.jpg){#fig-cs3}

![Case study #4: electric power system frequency response, obtained with SFRM and UL UFLS (ellipse-shaped threshold function)](Fig4_CS4.jpg){#fig-cs4}
