...
bibliography: ../_bibliography/authorGuidelines.bib
number-sections: true
---

This page provides some general writing guidelines for authors of the page. This page takes inspiration from [@EditorialStyleManualAuthors],  [@EditingMathematics], [@ManualofStyle], [@StandardDictionary].
...
### Title
 ...
 Please refer to chapter 2 part A of the [@EditorialStyleManualAuthors]
...
Please consult the decicated section on references and other types of Papers in [@EditorialStyleManualAuthors].

### Text citation of Figures and Tables

Please consult the decicated section on text citations of Figures and Tables in [@EditorialStyleManualAuthors].

### Other text

Please consult the decicated section on inclusive language, footnotes, and lists in text in [@EditorialStyleManualAuthors].

### Writing style

Please consult the decicated section on : Acronyms, spelling, trademarks, plurals, hyphenation rules, grammar, contractions, capitalization, Dates, percentages and decimals, Ranges wit units in chapter E. Writing Style for Transactions in [@EditorialStyleManualAuthors].

### Grammar and usage

For guidance in grammar and usage, please consult the  [@ManualofStyle] and Chapter III. Grammer and usage in transactions from [@EditorialStyleManualAuthors].

### Mathematical editing

Please consult the [@EditingMathematics] for guidelines on how to write mathematics.

### Electrical and Electronics Terms, notations and conventions

Please consult the [@StandardDictionary] for the terms to be used in Electrical and Electronics fields.

For notations and conventions, please look at this [page](/about/notationAndConventions.html)

For electrical and eletronic diagram, you can refer to [@GraphicSymbolsElectricalElectronics] and [@SupplementGraphicSymbolElectricalElectronics]

For control terminology, you can check: [@AutomaticControlSystemDictionary]
