...
![Lookup table for reference rotation speed as a function of WT active power, ccording to @Lorenzo-Bonache2017_energies and with data from @DIgSILENT2024_powerfactory (see @tbl-wtLookupTable)](drawings/fig-lookup-table-omega-pref-output-1.png){#fig-lookup-table-omega-pref}
...
@fig-wtPControl [@Lorenzo-Bonache2019_iet].
...
the P control module section above.
