...
categories: ["#120", "pi-equivalent", "Frequency Dependent", "Martí", "EMT", "transient",  "transmission"]
date: 09/05/2024 
...
The developed model assumes the following equivalent circuit (@fig-fd-scheme):


![Equivalent circuit of the frequency dependent line](FD_scheme.svg){#fig-fd-scheme fig-align="center"}
...
![FD Thevenin Equivalent Circuit of a transmission line](FDLine_ThevEquiv.svg){#fig-fdline-thev-equiv fig-align="center"}
...
It can be converted into its Norton equivalent, as shown in @fig-fdline-norton-equiv:


![Norton Equivalent Circuit of a transmission line](FDLine_NortonEquiv.svg){#fig-fdline-norton-equiv fig-align="center"}
...
This rational expression can be expanded into partial functions when considering an R-C synthesis over the equivalent impedance (see @karni1966network):
...
The final equivalent circuit is the proposed by Dommel's work @dommel1969digital, with the difference that the impedance terms model the frequency dependence of the parameters. Detailed descriptions on the difference by the model proposed by Dommel and the frequency dependent model proposed by Martí can be found in @marti1981problem. The equivalent circuit is shown in the following figure:
