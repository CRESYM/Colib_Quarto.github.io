...
categories: ["#120", "pi-equivalent", "transmission", "steady-state", "Dynawo", "OpenIPSL", "opensource"]
date: 09/05/2024 
...
The derivation of the equations has been done starting from the distributed parameter model as in references @kundur1994power, @kothari2011modern, @salam2020fundamentals and @glover2015power. It then is transformed into a $\pi$-equivalent circuit for the general case of transmission lines.
...
The line parameters are obtained from the per-unit length values of resistance, inductance, capacitance and conductance, as described in references @kothari2011modern and @glover2015power. The total series impedance and shunt admittance of the line are calculated as:
...
![Schematic of the distributed parameter transmission line](distLine.svg){fig-align="center"}
...
![Pi-equivalent circuit of the lumped admittance transmission line](pi_eq_scheme.svg){fig-align="center"}
