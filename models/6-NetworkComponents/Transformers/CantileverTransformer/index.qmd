...
categories: ["#114", "Transformer", "Single-phase", "Cantilever equivalent", "Leakage flux", "Steady-state", "Phasorial", "Dynawo", "Modelica", "RMS"]
date: 02/05/2024 
...
Steady-state analysis of balanced three-phase transformers can be performed by using this single-phase model in one of the phases and then considering the phase shift for the rest of the phases. Depending on the configuration of the sides of the three-phase transformers (Delta-Delta, Star-Star, Delta-Star, Star-Delta), some rescaling of the impedances may be needed. Chapter 2.7 and Appendix A of @fitzgerald2002electric discuss the details of this analysis.
...
There are two physical parts of the transformers relevant for the model described, as seen in the following schematic representation @kothari2010electric:

![Transformer schematic representation](Trafo_scheme.svg){#fig-trafo-scheme fig-align="center"}
...
![T-equivalent circuit of a transformer](Tequiv_trafo.svg){#fig-t-equivalent}
...
![Cantilever equivalent circuit of a transformer](cantilever.svg){#fig-cantilever}
