...
categories: ["Opensource", "EMT", "voltage source", "converter", "STATCOM", "wind", "pv", "hvdc", "following"] 
date: 22/07/2024 
...
![STATCOM schematic.](EMT_STATCOM_scheme.svg){#fig-statcom-schematic width=100%}
...
![STATCOM DC Voltage Control open-loop diagram block.](DCVoltageControlSTATCOM.svg){#fig-dc-voltage-control}
...
![STATCOM DC Voltage Control closed-loop diagram block.](DCControlErrorSTATCOM.svg){#fig-dc-control-error}
