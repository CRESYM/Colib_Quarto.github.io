...
categories: ["#24","opensource","phasor", "HVDC", "VSC", "generic", "MRL4", "Single phase", "dynawo"]
date: 21/06/2023 
last-updated: 29/03/2024
id: #91
author: Mathilde Bongrain (CRESYM)
reviewers: 
...
![General view of the HVDC VSC standard model: physical and control connections](HvdcVSC.svg){fig-align="center"}

::: {.figure-caption}
Figure 1: General view of the HVDC VSC standard model: physical and control connections
:::
...
![DC and AC sides of the converter](HVDCVSCACDCConverterView.svg){fig-align="center"}

::: {.figure-caption}
Figure 2: DC and AC sides of the converter
:::
...
![Current injection](HVDCVSCConverterCurrentSourceAdmittance.svg){fig-align="center"}

::: {.figure-caption}
Figure 3: Current injection
:::
...
![Electrotechnical components representing the DC side](HVDCVSCDCLinkPhysicalModel.svg){fig-align="center"}

::: {.figure-caption}
Figure 4: Electrotechnical components representing the DC side
:::
...
![P control of the VSC](HVDCVSCPControl.svg){fig-align="center"}

::: {.figure-caption}
Figure 5: P control of the VSC
:::
...
![Delta P calculation](HVDCVSCDeltaP.svg){fig-align="center"}

::: {.figure-caption}
Figure 6: Delta P calculation
:::
...
![VDC control of the VSC](HVDCVSCVDCControl.svg){fig-align="center"}

::: {.figure-caption}
Figure 7: VDC control of the VSC
:::
...
![Q mode of the U AC control of the VSC](HVDCVSCUACControlQmode.svg){fig-align="center"}

::: {.figure-caption}
Figure 8: Q mode of the U AC control of the VSC
:::
...
![U mode of the U AC control of the VSC](HVDCVSCUACControlUmode.svg){fig-align="center"}

::: {.figure-caption}
Figure 9: U mode of the U AC control of the VSC
:::

$Q_{max_{comb}}$ and $Q_{min_{comb}}$ are a combinaison of the operational limits, the PQ limits and the UQ limits as follows:

![Combinaison of the operational, PQ and UQ limits](HVDCVSCQMaxMinComb.svg){fig-align="center"}

::: {.figure-caption}
Figure 10: Combinaison of the operational, PQ and UQ limits
:::
...
![calculation of the reference reactive current by the U AC control of the VSC](HVDCVSCUACControlIqref.svg){fig-align="center"}

::: {.figure-caption}
Figure 11: calculation of the reference reactive current by the U AC control of the VSC
:::
...
\begin{align}
U_{DC}^*(t=0) &= 1 \\
P_{SEC}(t=0) &= - U_{SEC}(t=0) \times I_{p,SEC}(t=0) \times \frac{S_n}{Sn^*} \\
Q_{SEC}(t=0) &= U_{SEC}(t=0) \times I_{q,SEC}(t=0) \times \frac{S_n}{S_n^*}
\end{align}
$$
...
$$
\begin{align}
\text{if } P_{SEC}^*(t=0) > 0 \text{ then:} \\
U_{DC, SEC}(t=0) &= 1 \text{ and} \\
U_{DC, REC}(t=0) &= 1 - R_{DC} \times P_{SEC}(t=0) \\
\text{else} \\
U_{DC, SEC}(t=0) &= 1 + R_{DC} \times P_{SEC}(t=0) \text{ and} \\
U_{DC, REC}(t=0) &= 1 \\
Q_{SEC}^*(t=0) &= - Q_{SEC}(t=0) \times \frac{S_n^*}{S_n} \\
P_{SEC}^*(t=0) &= - P_{SEC}(t=0) \times \frac{S_n^*}{S_n} \\
U_{SEC}^*(t=0) &= U_{SEC}(t=0) - \lambda \times Q_{SEC}(t=0) \times \frac{S_n^*}{S_n}
\end{align}
$$
