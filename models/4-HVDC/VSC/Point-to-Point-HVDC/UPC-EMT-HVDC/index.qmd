---
layout: page 
title: UPC generic EMT Point-to-Point HVDC model
categories: ["Opensource", "EMT", "voltage source", "converter", "hvdc", "point-to-point"] 
date: 03/07/2024 
...
The model is an HVDC transmission link with **A** voltage source converter (VSC) connected to the AC system through **B** (filters and transformers). This link transmits power from one AC grid to another AC grid. Each converter station is composed of both a controlled converter and an AC connection system.
...
![Equivalent circuit of the HVDC model](HVDC_scheme.svg){#fig-hvdc-scheme}
...
![Active power control diagram of the HVDC model](PcontrolHVDC.svg){#fig-hvdc-p-control}
<br>
