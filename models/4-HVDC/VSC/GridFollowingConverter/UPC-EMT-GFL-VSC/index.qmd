...
categories: ["Opensource", "EMT", "voltage source", "converter", "wind", "pv", "hvdc", "following", "NREL", "PSCAD", "DPSIM", "SimplusGrid", "Matlab"] 
date: 05/06/2024 
...
![EMT GF VSC scheme](EMT_GF_VSC_scheme.svg){fig-align="center"}

::: {.figure-caption}
Figure 1: EMT Grid Following VSC scheme [[1]](#1)
:::
...
![PLL Control Diagram](PLL_ControlDiagram.svg){fig-align="center"}

::: {.figure-caption}
Figure 2: PLL Control Diagram [[3]](#3)
:::
...
![PLL Control Diagram](LinearPLLBlock.svg){fig-align="center"}
...
![Current Control Diagram](CurrentControlDiagram.svg){fig-align="center"}

::: {.figure-caption}
Figure 4: Current Control Diagram [[3]](#3)
:::
...
![Current Error Diagram](CurrentErrorVSC.svg){fig-align="center"}
...
![Power Control Diagram](PowerLoopVSC.svg){fig-align="center"}

::: {.figure-caption}
Figure 6: Power Control Diagram [[3]](#3)
:::
...
![Error power loop](ErrorPowerLoopVSC.svg){fig-align="center"}
...
![Anti-Windup Control Diagram](PI_antiwindup.svg){fig-align="center"}
...
![Anti-Windup Control Diagram](PI_antiwindup_alternative.svg){fig-align="center"}
