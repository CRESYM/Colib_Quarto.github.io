...
![Phasor-I0 Model Block Diagram](PhasorI0.svg){fig-align="center"}

::: {.figure-caption}
Figure 1: Phasor-I0 Model Block Diagram [[1]](#1)
:::
...
where $v_g^{q}$ can be considered to be $V_{peak}$. The controller is then:
