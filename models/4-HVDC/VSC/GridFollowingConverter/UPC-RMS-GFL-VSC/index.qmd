...
categories: ["Opensource", "Phasor", "voltage source", "converter", "wind", "pv", "hvdc"] 
date: 26/06/2024 
...
![phasor GF VSC scheme](FullPhasor_GF_VSC.svg){fig-align="center"}

::: {.figure-caption}
Figure 1: Phasor Grid Following VSC scheme [[2]](#2)
:::
...
![Angle Tracking Diagram](Phasor_qd0_GF.svg){fig-align="center"}
...
::: {.figure-caption}
Figure 3: Current Control Diagram [[3]](#3)
:::
...
![Current Error Diagram](CurrentErrorVSC_Phasor.svg){fig-align="center"}
...
::: {.figure-caption}
Figure 5: Power Control Diagram [[3]](#3)
:::
...
![Power Control Diagram](ErrorPowerLoopVSC.svg){fig-align="center"}
...
![Phasor Models Comparison](ErrorPlot_Phasor.svg){fig-align="center"}

::: {.figure-caption}
Figure 7: Phasor Models Error Comparison [[1]](#1)
:::
...
![Phasor Models Suitability](Phasor_suitability.svg){fig-align="center"}

::: {.figure-caption}
Figure 8: Phasor Models Suitability [[1]](#1)
:::
