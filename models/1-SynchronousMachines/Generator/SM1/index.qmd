...
categories: ["#110","Synchronous machine", "RMS", "EMT", "Phasor", "Rotor", "Stator", "Dynawo", "Opensource", "GENROU", "GENSAL"]
date: 10/04/2024 
...
![Synchronous machine model schematic](./SM1_model_scheme.svg){#fig-sm1-model-scheme}
...
![Stator-rotor of a Synchronous Machine schematic](./SM_rot_stat.svg){#fig-sm-rot-stat}
...
\frac{d\theta_{shaft}}{dt} = \frac{2}{p_f} \omega_m\\
\end{align}
$$
...
![Capability curve of a Synchronous Generator](./SM_CapCurve.svg){#fig-sm-cap-curve}

![Compound curves of a Synchronous Generator](./SM_CompCurves.svg){#fig-sm-comp-curves}
...
- [GENROU/GENSAL](../GENSAL/)
- [GENTPF/GENTPJ](../GENTPJ/)
- [GENQEC](../GENQEC/)
