...
layout: page
title: OEL2C
categories: ["Voltage regulator", "OEL2C", "generic", "Opensource", "CIM model", "RMS", "phasor", "MRL4", "Single phase", "IEEE", "dynawo", "#236"]
date: 08/10/2024
...
This overexcitation limiter model first appeared in the IEEE Std 421.5-2016 [@IEEEExciterModels2016].

## Model use, assumptions, validity domain and limitations

This model is associated to one of the voltage regulators (types AC, DC, ST) defined by the IEEE Std 421.5-2016 [@IEEEExciterModels2016].
...
![OEL2C model diagram](OEL2C.drawio.svg){#fig-oel2c}

The OEL reference current is calculated with the following model :

![OEL reference current calculation model](OelReferenceCurrent.drawio.svg){#fig-oel-ref-current}
