...
layout: page
title: AC7C
categories: ["Voltage regulator", "AC7C", "generic", "Opensource", "CIM model", "RMS", "phasor", "MRL4", "Single phase", "ExcIEEEAC7C", "IEEE", "dynawo", "#106"]
date: 05/04/2024
...
|$K_r$ |Field voltage feedback gain|${pu}$|
...
|$X_l$ |Reactance associated with potential source |${pu}$ (base $S N_{om}$, $U N_{om}$)|
