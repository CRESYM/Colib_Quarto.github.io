...
categories: ["control block", "timer"]
...
![Timer diagram](timer.svg){#fig-timer}

::: {#fig-timer}
Timer control block diagram
:::

![Detailed timer diagram](detailedTimer.svg){#fig-detailed-timer}

::: {#fig-detailed-timer}
Detailed timer control block diagram
:::
