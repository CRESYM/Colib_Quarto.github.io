...
categories: ["control block", "PI", "Proportional Integral", "non-windup", "limits"]
...
::: {.figure-caption}
Proportional integral (PI) controller with non-windup limit on the integral term and limit on the proportional term diagram
:::
