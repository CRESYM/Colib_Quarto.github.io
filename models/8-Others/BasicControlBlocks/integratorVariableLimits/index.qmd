...
categories: ["control block", "integrator", "limited integrator"]
...
::: {.figure-caption}
Integrator control block with (positive) time constant T and non-windup variable limits on output diagram
:::
